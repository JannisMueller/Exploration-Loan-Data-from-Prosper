...
I'll start by looking at the distribution of the main variable of interest ProsperScore, TotalProsperPaymentsBilled, BorrowerRate, StatedMonthlyIncome and MonthlyLoanPayment.
...
d
efault_color = sb.color_palette()[0]
sb.countplot(data = loan_data_clean, x = 'Term', color = default_color, ax = ax[0])
sb.countplot(data = loan_data_clean, x = 'EmploymentStatus', color = default_color, ax = ax[1])
sb.countplot(data = loan_data_clean, x = 'BorrowerAPR', color = default_color, ax = ax[2])
sb.countplot(data = loan_data_clean, x = 'IncomeRange', color = default_color, ax = ax[3])
sb.countplot(data = loan_data_clean, x = 'OpenCreditLines', color = default_color, ax = ax[4])
sb.countplot(data = loan_data_clean, x = 'LoanOriginalAmount', color = default_color, ax = ax[5])
